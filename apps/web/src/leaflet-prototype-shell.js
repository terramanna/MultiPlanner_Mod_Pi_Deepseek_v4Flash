...
function renderProviderControls() {
  return `<label for="providerSelect">Data provider</label>
    ...
    <label class="prototype-coverage-toggle"><input id="networkToggle" type="checkbox" /> Show Network Primary and Nominal Links</label>
    <label class="prototype-coverage-toggle"><input id="networkOtherToggle" type="checkbox" /> Show all other links</label>
